            ...
            child: Row(
              children: [
                ...
                SizedBox(
                  ...
                  child: Text(
                    TableData
                        .data.standing.standings[0].standings[index].position
                        .toString(),
                ...
                SizedBox(
                  width: 140,
                  child: Text(
                    TableData.data.standing.standings[0].standings[index].team
                        .nameFa,
                    textAlign: TextAlign.left,
                    maxLines: 1,
                  ),
                ...
                Expanded(
                  child: Text(
                    TableData
                        .data.standing.standings[0].standings[index].matchPlayed
                        .toString(),
                ...
                Expanded(
                  child: Text(
                    TableData.data.standing.standings[0].standings[index].win
                        .toString(),
                    textAlign: TextAlign.center,
                  ),
                ),
                ...
                Expanded(
                  child: Text(
                    TableData.data.standing.standings[0].standings[index].draw
                        .toString(),
                    textAlign: TextAlign.center,
                  ),
                ),
                ...
                Expanded(
                  child: Text(
                    TableData.data.standing.standings[0].standings[index].lose
                        .toString(),
                    textAlign: TextAlign.center,
                  ),
                ),
